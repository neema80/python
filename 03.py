...
# num = eval(input("Enter a number: ")) # by default the format is tring if we want to calculate it we have to change the format
                        # using the eval function
#print("number is {}".format(num), " type is: ", type(num))
#
